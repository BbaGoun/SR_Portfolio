...
_uint CLoadingThread::Loading_Stage()
{
    ...
    if (FAILED(CProtoMgr::GetInstance()->Ready_Prototype(L"Proto_BoosterEffect", Engine::CTexture::Create(m_pGraphicDev, TEX_NORMAL, L"../Bin/Resource/Cart/Effect/Boost/booster.png", 1))))
        return E_FAIL;
