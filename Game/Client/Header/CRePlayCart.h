...
class CRePlayCart : public CGameObject
{
private:
	explicit CRePlayCart(LPDIRECT3DDEVICE9 pGraphicDev);
	explicit CRePlayCart(const CGameObject& rhs);
	virtual ~CRePlayCart() override;
...
public:
	static CRePlayCart* Create(LPDIRECT3DDEVICE9 pGraphicDev);
	// KeyInput
