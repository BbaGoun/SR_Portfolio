...
class CLeftSideMirrorCam : public CCamera
{
private:
	explicit CLeftSideMirrorCam(LPDIRECT3DDEVICE9 pGraphicDev);
	explicit CLeftSideMirrorCam(const CLeftSideMirrorCam& rhs);
	virtual ~CLeftSideMirrorCam();
...
public:
	static CLeftSideMirrorCam* Create(LPDIRECT3DDEVICE9 pGraphicDev,
